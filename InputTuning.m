function Ntwk = InputTuning(Ntwk, OKeeffe, plotdir)
%% Input tuning
...
tmp = (sum(Ntwk.wEI_initial(I1,E1), 2)).^2 + (sum(Ntwk.wIE_initial(E1, I1)', 2)).^2;
...
tmp = (sum(Ntwk.wEI_initial(I2, E2), 2) ).^2 + (sum(Ntwk.wIE_initial(E2, I2)', 2)).^2;
